...
if (!isset($_SESSION['username'])) {
  header("Location: adminlogincss.php");
...
<h2>Admin Dashboard </h2>
    <div class="profile-container">
        ...
        <div class="left-side">
        <img id="profilepicture" src="flowerrabbit.png" alt="Graduation Cap and Scroll">
        </div>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      $username = $row['username'];
        ...
        echo '<tr>
            ...
            <td>' . $institute . '</td>
            <td> 
	<button class= "btn btn-danger"><a class="text-light" href="userdashboarddelete.php? deleteid='.$username.'">Delete</a></button>
	</td>
        </tr>';
    }
